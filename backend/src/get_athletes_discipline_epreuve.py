...
def get_athletes_discipline_epreuve(discipline: str, epreuve: str) : 
    """
        Récupère les athlètes en fonction de la discipline et de l'épreuve
    """
    data = []
    limit = 100
    offset = 0
    ...
    while True:
        ...
        params = {
            ...
            "where": 'discipline = "{}" and event = "{}"'.format(discipline, epreuve),
            "limit": limit,
            "offset": offset
        }
