...
function renderClassement() {
  ...
  function renderHeader() {
    classement.innerHTML =
      `<div class="classement_sous_header">
          ...
          <div class="nb_gold_medals" id="nb_gold_medals">
            <span>Or</span>
          </div>

          <div class="nb_silver_medals" id="nb_silver_medals">
            <span>Argent</span>
          </div>

          <div class="nb_bronze_medals" id="nb_bronze_medals">
            <span>Bronze</span> 
          </div> 
        </div>
      `;

    const nb_bronze_medals = document.getElementById("nb_bronze_medals");
    const nb_gold_medals = document.getElementById("nb_gold_medals");
    const nb_silver_medals = document.getElementById("nb_silver_medals");

    if (window.innerWidth < 768) {
      // version mobile et écran pc séparé en deux : cercles
      makeCircle(nb_bronze_medals, "#CD7F32");
      makeCircle(nb_gold_medals, "#FFD700");
      makeCircle(nb_silver_medals, "#adadad");
    } else {
      // version plein écran
      nb_bronze_medals.textContent = "Bronze";
      nb_bronze_medals.style.backgroundColor = "";
      nb_bronze_medals.style.width = "";
      nb_bronze_medals.style.height = "";
      nb_bronze_medals.style.borderRadius = "";
      nb_bronze_medals.style.display = "";
      nb_bronze_medals.style.justifyContent = "";
      nb_bronze_medals.style.alignItems = "";

      nb_gold_medals.textContent = "Or";
      nb_gold_medals.style.backgroundColor = "";
      nb_gold_medals.style.width = "";
      nb_gold_medals.style.height = "";
      nb_gold_medals.style.borderRadius = "";
      nb_gold_medals.style.display = "";
      nb_gold_medals.style.justifyContent = "";
      nb_gold_medals.style.alignItems = "";

      nb_silver_medals.textContent = "Argent";
      nb_silver_medals.style.backgroundColor = "";
      nb_silver_medals.style.width = "";
      nb_silver_medals.style.height = "";
      nb_silver_medals.style.borderRadius = "";
      nb_silver_medals.style.display = "";
      nb_silver_medals.style.justifyContent = "";
      nb_silver_medals.style.alignItems = "";
    }
  }

  // fonction pour créer les cercles
  // Pour ne pas recopier les lignes pour chaque type de médaille
  function makeCircle(div, color) {
    div.textContent = "";
  ...
  // En passant par FastAPI  
  fetch(`http://127.0.0.1:8000/classement`)
  .then(response => response.json())
  .then(paysNbMedals => {
    paysNbMedals.forEach((element, i) => {
      const div_ligne = document.createElement("div");
      div_ligne.className = "classement_sous";
      ...
      const nom = document.createElement("div");
      nom.className = "nom_pays";
      const drapeau_name = createFlagWithName(element["pays"]);
      nom.innerHTML = drapeau_name;

      const gMedals = document.createElement("div");
      gMedals.className = "nb_gold_medals";
      gMedals.textContent = element["gold"];

      const sMedals = document.createElement("div");
      sMedals.className = "nb_silver_medals";
      sMedals.textContent = element["silver"];

      const bMedals = document.createElement("div");
      bMedals.className = "nb_bronze_medals";
      bMedals.textContent = element["bronze"];
  ...
  // Coder en dur avec les infos déjà présentes dans le fichier js
//     classementJO.forEach((line, i) => {
//         const div_ligne = document.createElement("div");
//         div_ligne.className = "classement_sous";
